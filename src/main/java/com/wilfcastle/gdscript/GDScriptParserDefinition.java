...
import com.wilfcastle.gdscript.parser.GDScriptParser;
import com.wilfcastle.gdscript.psi.GDScriptFile;
...
public class GDScriptParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet COMMENTS = TokenSet.create(GDScriptTypes.COMMENT);
    ...
    public PsiElement createElement(ASTNode node) {
        return GDScriptTypes.Factory.createElement(node);
    }
}